...
async def on_message(message):
    ...
    if message.content == '!Commands':
        await client.send_message(message.channel,'MRKOS COMMANDS : !DSP / !dsp = Picks a random Deep Sea Prisioner Character ; !Mrkos ; !Relax ; !Bofa ; !Ligma ; !Vine / !vine ; !img ; !Hello ; !How are you / !How are you? ; !Dari ; !Ross ; !Spoon ; !Asher ; !Souta ; !Play ; !Honda ; !Memes')
    ...
    if message.content.startswith('!Memes'):
        randomlist = ["https://youtu.be/bQt8aK4Q6-Q","https://youtu.be/L5QerERTDAg","https://youtu.be/PYScLW8Cxh4","https://youtu.be/DOV55eI8V98"]
        await client.send_message(message.channel,(random.choice(randomlist)))
    ...
    if message.content.startswith('!Souta'):
        randomlist = ["Souta is pretty 'chicks'!","Girly boy!","Souta's the scary one.","Souta's doing alright~!","Do not touch brother's pretty boy! He gets really angry."]
        await client.send_message(message.channel,(random.choice(randomlist)))
    ...
    if message.content.startswith('!Honda'):
        randomlist = ["Hehe! When you honk at him, he panics and sounds his car alarm!"]
        await client.send_message(message.channel,(random.choice(randomlist)))
